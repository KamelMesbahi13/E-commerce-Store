...
const Nav = () => {
  ...
  return (
    <>
      <div id="nav" className="z-10 w-full relative bg-[#0009] py-3">
          ...
          <div className="flex justify-between py-1 overflow-hidden">
            ...
            <div className="md:hidden">
              ...
              <div
                className={
                  nav
                    ? "absolute duration-500 right-[110%] p-4 text-center w-full h-[150vh]"
                    : "absolute text-center duration-500 right-[0%] w-full bg-[#000000c2] h-[150vh] p-4"
                }
              >
                <div>
                  <div>
                  ...
                  <div className="flex flex-col">
                    ...
                    <Link className="nav-link-sm" onClick={navHandle} to="/men">
                      Men
                    </Link>
                    <Link
                      className="nav-link-sm"
